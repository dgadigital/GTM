...
<section
  ...
  class="two-column-section section-<?php echo esc_attr($section_index); ?> <?php echo esc_attr(trim($background_color . ' ' . $font_color . ' ' . $reverse_class)); ?>"
...
>
  <div class="container">
    ...
    <?php if (!empty($section_description)): ?>
      <div class="section-description"><?php echo esc_html($section_description); ?></div>
    <?php endif; ?>
  </div>

  <div class="container">
    <div class="content-wrapper d-flex flex-column flex-lg-row <?php echo esc_attr($reverse_class); ?>">
      ...
      <div class="form-col">
        <?php if (!empty($form_content)): ?>
          <div class="form-wrapper"><?php echo wp_kses_post($form_content); ?></div>
        <?php endif; ?>
      </div>
